...
/**
 * Interceptor for {@link ClientHttpRequestExecution} objects created for server
 * to server secured communication using OAuth2 bearer tokens issued by
 * Keycloak.
 *
...
public class KeycloakInterceptor implements ClientHttpRequestInterceptor {
	 ...
	 * this point, only {@link KeycloakPrincipal} values are supported
	 *
