 ...
 */
@Component
public class IndicatorImportHandler extends AbstractImportHandler<ImportIndicatorPOSTInputType> {
    ...
    @Override
    public ResponseEntity<List<String>> importResource(ImportIndicatorPOSTInputType importResourceType,
        ...
        indicatorPostInput = encoder.encode(importResourceType, spatialResources);
