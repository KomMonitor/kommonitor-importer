...
public interface GeoresourcesApi {
    ...
    public static final String PATH_IMPORT_GEORESOURCE = "/georesources";
    /**
    ...
    @RequestMapping(
        ...
        value = GeoresourcesApi.PATH_IMPORT_GEORESOURCE,
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = GeoresourcesApi.PATH_UPDATE_GEORESOURCE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
