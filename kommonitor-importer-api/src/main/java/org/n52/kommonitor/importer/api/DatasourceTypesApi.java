...
public interface DatasourceTypesApi {
    ...
    public static final String PATH_GET_SUPPORTED_DATA_SOURCE_TYPE_BY_TYPE = "/datasourceTypes/{type}";
    /**
    ...
    @RequestMapping(
        ...
        value = DatasourceTypesApi.PATH_GET_SUPPORTED_DATA_SOURCE_TYPE_BY_TYPE,
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = DatasourceTypesApi.PATH_GET_SUPPORTED_DATA_SOURCE_TYPES,
        produces = { "application/json" }
    )
