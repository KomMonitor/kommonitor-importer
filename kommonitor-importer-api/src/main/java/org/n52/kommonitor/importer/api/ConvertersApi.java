...
public interface ConvertersApi {
    ...
    public static final String PATH_GET_CONVERTER_BY_NAME = "/converters/{name}";
    /**
    ...
    @RequestMapping(
        ...
        value = ConvertersApi.PATH_GET_CONVERTER_BY_NAME,
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = ConvertersApi.PATH_GET_CONVERTERS,
        produces = { "application/json" }
    )
